...
BEGIN
    ...
    if char_length(null_cols_statement) > 0 or char_length(empty_cols_statement) > 0 then
        set_cols_statement := ' set ' || null_cols_statement || empty_cols_statement;
