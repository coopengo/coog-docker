...
function startContainer() {
    # BACK
    # docker-compose up postgres initcoog reverse-proxy coog static redis unoconv &
    # FRONT
    #docker-compose up mongo gateway api api-identity-manager web &
    # FULL
    docker-compose up postgres initcoog reverse-proxy coog static redis unoconv mongo gateway api api-identity-manager web &
}
